...
function milad(variable){
    if(typeof variable === 'object'){
        let newObject={}
        let list = ['hi']
        
        for(const [k,v] of Object.entries(variable)){
            if(typeof variable[k]=== 'object'){
         newObject[k] =`contains: ${variable[k]}`
        }
            else if(typeof variable[k] === 'string'){
                newObject[k] = v
            }
